    ...
    def on_create_clicked(self):
        ...
        if create_dialog.exec_() == QDialog.Accepted:
            ...
            try:
                ...
                self.table.setItem(row_position, 0, QTableWidgetItem(record_data['service']))
                self.table.setItem(row_position, 1, QTableWidgetItem(record_data['category']))
                self.table.setItem(row_position, 2, QTableWidgetItem(str(record_id)))
